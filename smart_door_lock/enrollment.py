...
Mirip add_faces.py tapi dengan modul yang lebih terorganisir
"""
...
def main():
    ...
    detector = FaceDetector(use_onnx=False)  # Use Haar Cascade
    ...
    while True:
        ...
        for detection in detections:
            ...
            if frame_count % ENROLLMENT_SAMPLE_INTERVAL == 0:
                ...
                print(f"\r[CAPTURE] Samples collected: {sample_count}/{ENROLLMENT_SAMPLES}", end="")
